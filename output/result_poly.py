...
def modele():
    ...
    ##############################
    # subd of init
    init.subs = {Sub('0'): Cell_0, Sub('1'): Cell_0, Sub('2'): Cell_0, Sub('3'): Cell_0, Sub('4'): Cell_0, Sub('5'): Cell_0}
    ##############################
    # edges of all states
    Cell_0.bords = {Bord('0'): B2, Bord('1'): B2, Bord('2'): B2, Bord('3'): B2}
    ##############################
    # subdivisions of all states
    Cell_0.subs = {Sub('0'): Cell_0, Sub('1'): Cell_0, Sub('2'): Cell_0, Sub('3'): Cell_0, Sub('4'): Cell_0}
    ##############################
    ...
    Cell_0(Bord('0') + Sub('0') + Permut('0'), Sub('0') + Bord('2'))
    Cell_0(Bord('3') + Sub('1') + Permut('0'), Sub('0') + Bord('3'))
    Cell_0(Bord('1') + Sub('1') + Permut('0'), Sub('1') + Bord('0'))
    Cell_0(Bord('2') + Sub('0') + Permut('0'), Sub('1') + Bord('3'))
    Cell_0(Bord('2') + Sub('1') + Permut('0'), Sub('2') + Bord('0'))
    Cell_0(Bord('3') + Sub('0') + Permut('0'), Sub('2') + Bord('3'))
    Cell_0(Bord('1') + Sub('0') + Permut('0'), Sub('3') + Bord('1'))
    Cell_0(Bord('0') + Sub('1') + Permut('0'), Sub('3') + Bord('2'))
