...
def modele():
    ...
    ##############################
    # all cells states
    # B_2_0 - B_2_0 - C_2_0 - B_2_0 / C_2_0 - B_2_0 - B_2_0 / 0
    ...
    ##############################
    # subd of init
    init.subs = {Sub('0'): Cell_0, Sub('1'): Cell_1, Sub('2'): Cell_2_1, Sub('3'): Cell_1, Sub('4'): Cell_0}
    ##############################
    # edges of all states
    Cell_0.bords = {Bord('0'): B2, Bord('1'): B2, Bord('2'): C2, Bord('3'): B2}
    Cell_1.bords = {Bord('0'): C2, Bord('1'): B2, Bord('2'): C2_1, Bord('3'): B2}
    Cell_2_1.bords = {Bord('0'): C2_1, Bord('1'): B2_1, Bord('2'): C2_1, Bord('3'): B2_1}
    ...
    Cell_5.bords = {Bord('0'): C2, Bord('1'): B2, Bord('2'): C2, Bord('3'): B2}
    ##############################
    # subdivisions of all states
    Cell_0.subs = {Sub('0'): Cell_3, Sub('1'): Cell_4, Sub('2'): Cell_4, Sub('3'): Cell_3}
    Cell_1.subs = {Sub('0'): Cell_4, Sub('1'): Cell_4, Sub('2'): Cell_4}
    Cell_2_1.subs = {Sub('0'): Cell_5}
    ...
    Cell_5.subs = {Sub('0'): Cell_4, Sub('1'): Cell_4, Sub('2'): Cell_4, Sub('3'): Cell_4}
    ##############################
    ...
    Cell_2_1.space = [Bord_('0'), Bord_('1'), Bord_('2'), Bord_('3')]
    ...
    Cell_0(Bord('2') + Sub('1'), Sub('2') + Bord('5'))
    Cell_0(Bord('3') + Sub('0'), Sub('2') + Bord('0'))
    Cell_0(Bord('3') + Sub('1'), Sub('3') + Bord('0'))
    Cell_0(Bord('0') + Sub('0'), Sub('3') + Bord('1'))
    # adjacency constraints
    Cell_0(Sub('0') + Bord('2') + Permut('0'), Sub('1') + Bord('5'))
    Cell_0(Sub('1') + Bord('3') + Permut('0'), Sub('2') + Bord('3'))
    Cell_0(Sub('2') + Bord('1') + Permut('0'), Sub('3') + Bord('4'))
    ...
    # incidence constraints
    Cell_1(Bord('0') + Sub('1'), Sub('0') + Bord('5'))
    Cell_1(Bord('1') + Sub('0'), Sub('0') + Bord('0'))
    Cell_1(Bord('1') + Sub('1'), Sub('1') + Bord('0'))
    Cell_1(Bord('2') + Sub('0'), Sub('1') + Bord('1'))
    Cell_1(Bord('3') + Sub('0'), Sub('1') + Bord('2'))
    Cell_1(Bord('3') + Sub('1'), Sub('2') + Bord('0'))
    Cell_1(Bord('0') + Sub('0'), Sub('2') + Bord('1'))
    # adjacency constraints
    Cell_1(Sub('0') + Bord('1') + Permut('0'), Sub('1') + Bord('5'))
    Cell_1(Sub('1') + Bord('3') + Permut('0'), Sub('2') + Bord('5'))
    Cell_1(Sub('2') + Bord('3') + Permut('0'), Sub('0') + Bord('3'))
    # edges adjacency constraints
    ...
    Cell_2_1(Bord('1') + Sub('0'), Sub('0') + Bord('1'))
    Cell_2_1(Bord('2') + Sub('0'), Sub('0') + Bord('2'))
    Cell_2_1(Bord('3') + Sub('0'), Sub('0') + Bord('3'))
    # adjacency constraints
    # edges adjacency constraints
    Cell_2_1(Bord('0') + Bord('1'), Bord('1') + Bord('0'))
    Cell_2_1(Bord('1') + Bord('1'), Bord('2') + Bord('0'))
    Cell_2_1(Bord('2') + Bord('1'), Bord('3') + Bord('0'))
    Cell_2_1(Bord('3') + Bord('1'), Bord('0') + Bord('0'))
    # incidence constraints
    ...
    Cell_5(Bord('2') + Sub('1'), Sub('2') + Bord('5'))
    Cell_5(Bord('3') + Sub('0'), Sub('2') + Bord('0'))
    Cell_5(Bord('3') + Sub('1'), Sub('3') + Bord('0'))
    Cell_5(Bord('0') + Sub('0'), Sub('3') + Bord('1'))
    # adjacency constraints
    Cell_5(Sub('0') + Bord('1') + Permut('0'), Sub('1') + Bord('5'))
    Cell_5(Sub('1') + Bord('3') + Permut('0'), Sub('2') + Bord('3'))
    Cell_5(Sub('2') + Bord('1') + Permut('0'), Sub('3') + Bord('5'))
    Cell_5(Sub('3') + Bord('3') + Permut('0'), Sub('0') + Bord('3'))
    # edges adjacency constraints
