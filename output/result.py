...
def modele():
    ...
    ##############################
    # all cells states
    # B_2_0 - B_2_0 - B_2_0 - B_2_0 - B_2_0 - B_2_0 - B_2_0 - B_2_0 / B_2_0 - B_2_0 - B_2_0 / 0 / 1
    ...
    ##############################
    # edges of all states
    Cell_0.bords = {Bord('0'): B2, Bord('1'): B2, Bord('2'): B2, Bord('3'): B2, Bord('4'): B2, Bord('5'): B2, Bord('6'): B2, Bord('7'): B2}
    Cell_1.bords = {Bord('0'): B2, Bord('1'): B2, Bord('2'): B2, Bord('3'): B2, Bord('4'): B2}
    ##############################
    # subdivisions of all states
    Cell_0.subs = {Sub('0'): Cell_1, Sub('1'): Cell_1, Sub('2'): Cell_1, Sub('3'): Cell_1, Sub('4'): Cell_1, Sub('5'): Cell_1, Sub('6'): Cell_1, Sub('7'): Cell_1}
    Cell_1.subs = {Sub('0'): Cell_1, Sub('1'): Cell_1, Sub('2'): Cell_1, Sub('3'): Cell_1, Sub('4'): Cell_1}
    ##############################
    ...
    Cell_0(Bord('4') + Sub('0'), Sub('3') + Bord('1'))
    Cell_0(Bord('4') + Sub('1'), Sub('4') + Bord('0'))
    Cell_0(Bord('5') + Sub('0'), Sub('4') + Bord('1'))
    Cell_0(Bord('5') + Sub('1'), Sub('5') + Bord('0'))
    Cell_0(Bord('6') + Sub('0'), Sub('5') + Bord('1'))
    Cell_0(Bord('6') + Sub('1'), Sub('6') + Bord('0'))
    Cell_0(Bord('7') + Sub('0'), Sub('6') + Bord('1'))
    Cell_0(Bord('7') + Sub('1'), Sub('7') + Bord('0'))
    Cell_0(Bord('0') + Sub('0'), Sub('7') + Bord('1'))
    ...
    Cell_0(Sub('5') + Bord('2') + Permut('0'), Sub('6') + Bord('4'))
    Cell_0(Sub('6') + Bord('2') + Permut('0'), Sub('7') + Bord('4'))
    ...
    Cell_1(Bord('0') + Sub('0'), Sub('4') + Bord('1'))
    # adjacency constraints
