...
def modele():
	...
	etat0.initMat[Chem([Sub('6')])] = FMat([
		...
		[Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), ], 
	...
	etat0.initMat[Chem([Sub('5')])] = FMat([
		...
		[Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), Coef('Var', 0           ), ], 
