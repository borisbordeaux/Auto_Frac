...
# Automatically generated, from file : struct_poly_save.py, function : modele()
...
def modele():
	...
	etat0.initMat[Chem([Sub('8')])] = FMat([
		...
		[Coef('Var', math.sin(3*1.2) ), Coef('Var', math.sin(3*0.6) ), Coef('Var', math.sin(3*0)   ), Coef('Var', math.sin(3*0.6) ), Coef('Var', math.sin(3*1.2) ), Coef('Var', math.sin(3*1.2) ), ], 
	...
	etat0.initMat[Chem([Sub('7')])] = FMat([
		...
		[Coef('Var', math.sin(3*0)   ), Coef('Var', math.sin(3*0.6) ), Coef('Var', math.sin(3*1.2) ), Coef('Var', math.sin(3*0.6) ), Coef('Var', math.sin(3*0)   ), Coef('Var', math.sin(3*0)   ), ], 
		[Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), ], ])
	etat0.initMat[Chem([Sub('6')])] = FMat([
		...
		[Coef('Var', math.sin(3*2)   ), Coef('Var', math.sin(3*2.2) ), Coef('Var', math.sin(3*2.4) ), Coef('Var', math.sin(3*2.2) ), Coef('Var', math.sin(3*2)   ), Coef('Var', math.sin(3*1.5) ), Coef('Var', math.sin(3*1.2) ), Coef('Var', math.sin(3*1.2) ), Coef('Var', math.sin(3*1.2) ), Coef('Var', math.sin(3*1.5) ), ], 
	...
	etat0.initMat[Chem([Sub('5')])] = FMat([
		...
		[Coef('Var', math.sin(3*3)   ), Coef('Var', math.sin(3*2.5) ), Coef('Var', math.sin(3*2)   ), Coef('Var', math.sin(3*2)   ), Coef('Var', math.sin(3*2)   ), Coef('Var', math.sin(3*2.5) ), Coef('Var', math.sin(3*3)   ), Coef('Var', math.sin(3*3)   ), ], 
	...
	etat0.initMat[Chem([Sub('4')])] = FMat([
		...
		[Coef('Var', math.sin(3*4)   ), Coef('Var', math.sin(3*3.5) ), Coef('Var', math.sin(3*3)   ), Coef('Var', math.sin(3*2.7) ), Coef('Var', math.sin(3*2.4) ), Coef('Var', math.sin(3*2.2) ), Coef('Var', math.sin(3*2)   ), Coef('Var', math.sin(3*2.5) ), Coef('Var', math.sin(3*3)   ), Coef('Var', math.sin(3*3.5) ), ], 
		[Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), ], ])
	etat0.initMat[Chem([Sub('3')])] = FMat([
		...
		[Coef('Var', math.sin(3*2.4) ), Coef('Var', math.sin(3*2.7) ), Coef('Var', math.sin(3*3)   ), Coef('Var', math.sin(3*2.5) ), Coef('Var', math.sin(3*2)   ), Coef('Var', math.sin(3*2.2) ), ], 
		[Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), ], ])
	etat0.initMat[Chem([Sub('2')])] = FMat([
		...
		[Coef('Var', math.sin(3*5)   ), Coef('Var', math.sin(3*4.5) ), Coef('Var', math.sin(3*4)   ), Coef('Var', math.sin(3*4.5) ), Coef('Var', math.sin(3*5)   ), Coef('Var', math.sin(3*5)   ), ], 
		[Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), ], ])
	etat0.initMat[Chem([Sub('1')])] = FMat([
		...
		[Coef('Var', math.sin(3*5)   ), Coef('Var', math.sin(3*4.5) ), Coef('Var', math.sin(3*4)   ), Coef('Var', math.sin(3*4)   ), Coef('Var', math.sin(3*4)   ), Coef('Var', math.sin(3*4.5) ), ], 
		[Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), ], ])
	etat0.initMat[Chem([Sub('0')])] = FMat([
		...
		[Coef('Var', math.sin(3*3)   ), Coef('Var', math.sin(3*3.5) ), Coef('Var', math.sin(3*4)   ), Coef('Var', math.sin(3*4.5) ), Coef('Var', math.sin(3*5)   ), Coef('Var', math.sin(3*5)   ), Coef('Var', math.sin(3*5)   ), Coef('Var', math.sin(3*4)   ), ], 
		[Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), Coef('Const', 1           ), ], ])
	...
	etat1.space = [Chem([Bord('0'), Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('2'), Intern('0'), Intern('0'), ]), ]
	...
	etat4.space = [Chem([Bord('0'), Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('2'), Intern('0'), Intern('0'), ]), Chem([Bord('2'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('3'), Intern('0'), Intern('0'), ]), ]
	...
	etat6.space = [Chem([Bord('0'), Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('2'), Intern('0'), Intern('0'), ]), ]
	...
	etat7.subs    = {Sub('8'): etat7, Sub('7'): etat7, Sub('6'): etat7, Sub('5'): etat7, Sub('4'): etat7, Sub('3'): etat7, Sub('2'): etat7, Sub('1'): etat7, Sub('0'): etat7, Sub('G', True): Etat.etatPoint, Sub('10'): etat7, Sub('9'): etat7, Sub('18'): etat7, Sub('17'): etat7, Sub('16'): etat7, Sub('15'): etat7, Sub('14'): etat7, Sub('13'): etat7, Sub('12'): etat7, Sub('11'): etat7, }
	...
	etat7.space = [Chem([Bord('0'), Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('2'), Intern('0'), Intern('0'), ]), ]
	...
	etat9.space = [Chem([Bord('0'), Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Intern('0'), Intern('0'), ]), Chem([Bord('0'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('1'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('2'), Intern('0'), Intern('0'), ]), Chem([Bord('2'), Bord('1'), Intern('0'), Intern('0'), ]), Chem([Bord('3'), Intern('0'), Intern('0'), ]), ]
